...
|---|---|
| เวอร์ชัน | 4.2 |
| สถานะ | Gate 6 Passed; Orchard Two-View Selector and Complete Target Action Menu Approved for Mock-first Development; Limited Tree Register Operational Data Entry Authorized; Deployment Pending |
