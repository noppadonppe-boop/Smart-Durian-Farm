    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'annual-cycles', lazy: async () => ({ Component: (await import('../pages/AnnualCyclePage')).AnnualCyclePage }) },
          { path: 'reports', lazy: async () => ({ Component: (await import('../pages/ManagementReportsPage')).ManagementReportsPage }) },
