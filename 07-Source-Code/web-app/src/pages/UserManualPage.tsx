...
const manualTopics: readonly ManualTopic[] = [
  ...
  },
  {
    ...
    subtitle: 'ระบบตรวจเครือข่ายและ Firebase อัตโนมัติ เก็บรายการที่รองรับไว้ในเครื่อง และ Retry เมื่อกลับมาออนไลน์',
    ...
    steps: [
      {
        ...
        description: 'เมื่อเครือข่ายขาดหรือ Firebase ติดต่อไม่ได้ แอปจะแสดงแถบสีส้มว่า “ออฟไลน์” อัตโนมัติ หน้าที่มีข้อมูลแคชยังเปิดได้ และรูป/ร่างรายงานงานที่รองรับจะเข้าคิวในเครื่อง',
      },
      {
        number: 2,
      ...
      {
        number: 3,
        title: 'เมื่อกลับมามีเน็ต ระบบจะลองส่งให้อัตโนมัติ',
        actionTag: '🔄 เมนู ศูนย์ซิงก์ข้อมูล',
        description: 'ระบบตรวจ Firebase ทุก 1 นาทีและทันทีเมื่ออุปกรณ์แจ้งว่ากลับมาออนไลน์ จากนั้นจะ Retry รายการ Pending และชุดรูปโดยอัตโนมัติ หากต้องการตรวจทันที ให้เปิด “เพิ่มเติม” → “ศูนย์ซิงก์ข้อมูล” แล้วกด “ตรวจสอบ Firebase ตอนนี้”',
