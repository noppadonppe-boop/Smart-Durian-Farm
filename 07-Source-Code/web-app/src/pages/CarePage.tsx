...
export function CarePage() {
  ...
  const approve = async (event: CareEventRecord) => {
    ...
    try {
      ...
      await reload()
      setMessage('Agronomist อนุมัติ treatment แล้ว')
    } catch (cause) {
  ...
  return <section className="page-stack">
    ...
    {!loading && !error ? <p className="result-count">{visible.length} เหตุการณ์ · {currentFarm?.farmCode} · Firebase Production</p> : null}
